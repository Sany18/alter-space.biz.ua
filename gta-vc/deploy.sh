...
# build step. revcdos-bin/ is the engine + auto.html, compiled-data/vc-assets/
# is the converted GTA: Vice City game data. Both need to land under /gta-vc so
